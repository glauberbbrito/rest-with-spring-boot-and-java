package br.com.gbb.rest_with_spring_boot_and_java.controllres.docs;
...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Find All Books",
            ...
            responses = {
                    ...
                    @ApiResponse(description = "No Contet", responseCode = "204", content = @Content),
    ...
    BookDTO create(@RequestBody BookDTO books);
